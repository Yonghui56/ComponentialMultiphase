...
#ifndef NON_LINEAR_CMP_FLASH2PFORM_JACOBIAN_LOCAL_ASSEMBLER_H
#define NON_LINEAR_CMP_FLASH2PFORM_JACOBIAN_LOCAL_ASSEMBLER_H
...
class NonLinearCMP_Flash2PForm_JacobianLocalAssembler : public NumLib::IElementWiseTransientJacobianLocalAssembler
{
public:
	typedef MathLib::LocalVector LocalVectorType;
	typedef MathLib::LocalMatrix LocalMatrixType;
	NonLinearCMP_Flash2PForm_JacobianLocalAssembler(FemLib::LagrangeFeObjectContainer* feObjects, T_FUNCTION_DATA* func_data, const MeshLib::CoordinateSystem &problem_coordinates)
	...
	virtual ~NonLinearCMP_Flash2PForm_JacobianLocalAssembler()
    {
		_function_data = NULL; 
