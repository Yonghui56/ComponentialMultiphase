...
#ifndef ABSTRACTEOS_HETERO_PCPGFORM_H 
#define ABSTRACTEOS_HETERO_PCPGFORM_H 

#include "ChemLib/chemconst.h"

class AbstractEOS_hetero_PCPGForm {
public:
	/**
	  * constructor, input is the number of unknowns
	  */
	AbstractEOS_hetero_PCPGForm(std::size_t n_unknowns)
		:N(n_unknowns)
	{};
	...
	/**
	  ...
	  */
	virtual ~AbstractEOS_hetero_PCPGForm() {};
