...
#include "math.h"
#include <algorithm>
#include "AbstractEOS_hetero_PCPGForm.h"
#include <cmath>
 ...
 */
class EOS_hetero_PCPGForm : public AbstractEOS_hetero_PCPGForm
{
public:
	...
	/**
	  * Constructor
	  */
	EOS_hetero_PCPGForm() : AbstractEOS_hetero_PCPGForm(1)
    {
    };
