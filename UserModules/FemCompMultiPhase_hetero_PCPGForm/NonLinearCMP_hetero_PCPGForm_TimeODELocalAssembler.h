...
#ifndef NON_LINEAR_CMP_HETERO_PCPGFORM_TIME_ODE_LOCAL_ASSEMBLER_H
#define NON_LINEAR_CMP_HETERO_PCPGFORM_TIME_ODE_LOCAL_ASSEMBLER_H
...
class NonLinearCMP_hetero_PCPGForm_TimeODELocalAssembler : public T
{
public:
	typedef MathLib::LocalVector LocalVectorType;
	typedef MathLib::LocalMatrix LocalMatrixType;

	NonLinearCMP_hetero_PCPGForm_TimeODELocalAssembler(FemLib::LagrangeFeObjectContainer* feObjects, T_FUNCTION_DATA* func_data, const MeshLib::CoordinateSystem &problem_coordinates)
		: _feObjects(*feObjects), _function_data(func_data), _problem_coordinates(problem_coordinates)
	{
		
	};
	
	virtual ~NonLinearCMP_hetero_PCPGForm_TimeODELocalAssembler() {};
...
private:
	...
	LocalMatrixType PC_gp; // gas phase pressure
	LocalMatrixType PG_gp;// capillary pressure
